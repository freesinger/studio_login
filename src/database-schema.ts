export const requiredDatabaseColumns = {
  ...
  operator_prices: ['price_id', 'app_id', 'billing_item_id', 'customer_unit_price', 'cost_unit_price'],
  studio_tasks: ['task_id', 'connection_id', 'app_id', 'user_id', 'request_id', 'status'],
  studio_task_items: ['task_id', 'billing_item_id', 'estimated_usage', 'actual_usage', 'status'],
